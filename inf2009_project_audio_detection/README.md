...
4. *Status*:
- Distance Estimation: Implemented & Calibratable. (Completed)
- Speaker ID: Implemented & Persistent Storage. (Completed)
- Command Detection: Implemented (Vosk dependent). (Completed)
- MQTT Logging: Implemented. (Completed)
---
